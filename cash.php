...
<div class="container">
        ...
        <table>
            <tbody>
            <th><h1 style="color:black;font-size:50px;font-family:algeria">
                    <BR> PLEASE SELECT TYPE OF ACCOUNT<br><br><br><br>
                </h1>
            </th>
                <tr>
                    <td>
                        <a href="savings.php" class="button"><b>Savings</b></a> <br><br><br>&emsp; 
                    </td>
                    <td>
                        <a href="current1.php" class="button"><b>Current</b></a><br><br><br> 
                    </td>
                </tr>
				<tr>
				<td>
