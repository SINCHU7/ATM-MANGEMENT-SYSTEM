        ...
        <div class="container">
            ...
            <div class="row">
                <br><BR> <h7 style="font-family: algeria;font-style:normal; color: black"> <b><div class="col-xs-2"> </div>
                        <div class="col-xs-15"><center><?php echo "ADD THE AMOUNT TO DEPOSIT:"?></center> </div><br> </b></h7>
                             <br><input type="text" placeholder="Enter the amount to deposit"  class="form-control input-lg" name="cash"><br><br>
                 
                    
                 <input type="submit" class="button" value="Submit">&emsp;
                        <input type="submit" class="button" formaction="deposit1.php" value="Clear">
                            </form>
