...
if($row['account_type']!=$type){
    echo"<script>
alert('You have a savings account');
...
<div class="container">
            <div class="row">
                <Br><BR> <h7 style="font-family: algeria; font-style:normal;color: black"> <b><div class="col-xs-2"> </div>
                        <div class="col-xs-15"><center><?php echo "ENTER THE AMOUNT TO WITHDRAW:"?></center> </div></b></h7>
                            <br><br><input type="text" placeholder="Enter the amount to Withdraw"  class="form-control input-lg" name="cash"><br><br>
                            
                 
                    
                 <input type="submit" class="button" value="Submit">&emsp;
                        <input type="submit" class="button" formaction="current1.php" value="Clear">
                            </form>
